...
<div id="wrapper">
    ...
    <div id="content">
		<form action="" method="post" name="updateservice">
        	<label for="domainlist">Select domain</label>
            <select name="domainlist" style="width: 300px; height: 25px">
        	  <option selected>Example 01</option>
        	  <option>Example 02</option>
        	  <option>Example 03</option>
        	</select>
				...
				<%
                    try{
                        ...
                        if(lst != null){
                            ...
                            out.print("<thead>");
                            out.print("<tr>");
                            out.print("<th width=\"340px\">Service name</th>");
