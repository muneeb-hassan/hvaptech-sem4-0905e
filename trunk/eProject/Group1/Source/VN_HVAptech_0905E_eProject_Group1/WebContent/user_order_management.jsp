                    	...
                    	if(lst !=null){
	                    	...
	                    	for(Tblrequest p:lst){
	                        	...
	                        	out.println("<td>" + p.getDaterequest() + "</td>" 
	                        			...
	                        			+ "<td>" + p.getStatus() + "</td>" 
	                        			+ "<td><a href=\"user_order_detail.jsp?requestid=" + p.getId() + "\">View detail</a></td>" );
	                    		out.print("</tr>");
	                    	}
	                    	out.print("</tbody>");
	                    	out.print("</table>");
