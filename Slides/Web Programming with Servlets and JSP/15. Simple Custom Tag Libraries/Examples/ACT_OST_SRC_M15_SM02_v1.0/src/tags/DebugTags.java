 ...
 * DebugTags.java
 *
 * This program demonstrates the usage of tag files 
 *
...
/**
 * Generated tag handler class for DebugTags tag.
 * @author  pmayank
 * @version
 */

public class DebugTags extends BodyTagSupport {
    ...
    public int doStartTag() throws JspException, JspException {
        ...
        String debugFlag = (String)request.getAttribute("debug");
        if ((debugFlag != null) &&
