/*
 * UpperCase.java
 *This program demonstrates creating a classic custom tag that process the body
 *of the tag by convering the charecter string into Upper case.
 *
...
/**
 *UpperCase class is a tag handler class for a custom tag that needs to
 * manipulate its body by changing its case to Upper case.
 *
 * @author vincent
 */
public class UpperCase extends BodyTagSupport {
    ...
    //The current BodyContent is set
    public void setBodyContent(BodyContent bc) {
        //The current BodyContent is assigned to the instance of the tag handler
        super.setBodyContent(bc);
        //print the String value of bc
